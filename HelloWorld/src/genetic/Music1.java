...
public class Music1 {
    ...
    private static final int[] C_MAJOR_SCALE = {60, 62, 64, 65, 67, 69, 71, 72}; // C4 to C5
    ...
    public static void main(String[] args) {
        ...
        AudioConverter.Melody convertedMelody = AudioConverter.convertToMelody(melody);
        AudioConverter.printMelody(convertedMelody);
        
        System.out.println("\n" + "=".repeat(40));
        System.out.println("Playing melody...");
        SimpleAudioPlayer.playMelody(convertedMelody);
